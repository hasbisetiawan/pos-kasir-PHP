   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">@
              <?php echo date('Y');?> - SMK BAITUL HIKMAH | 
              By <a href="https://hasbisetiawan.github.io" style="font-weight:700;" target="_blank">Multimedia</a>
              <a href="#" class="go-top" style="background: #68dff0;">
